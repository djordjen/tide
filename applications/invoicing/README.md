...
browse order, update the existing dialog in place, load another opaque cursor
batch when needed, and require a changed draft to be saved or cancelled before
navigation.
